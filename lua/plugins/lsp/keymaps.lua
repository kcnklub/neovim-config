...
function M.on_attach(client, buffer)
    ...
    local refs = require("plugins.lsp.references")
    self:map("gr", function() refs.references(false) end, { desc = "References (no tests)" })
    self:map("gR", function() refs.references(true) end, { desc = "References (all)" })
